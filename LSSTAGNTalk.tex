...
\frametitle{Accretion Mechanism: The MRI}
  ...
  \centering
    ...
    \begin{column}{0.5\textwidth}
      ...
      %\end{figure}
      \movie[externalviewer]{\includegraphics[scale=0.5]{images/pol3d.jpg}}{disk04a.mpg}
...
\frametitle{Sources of variability}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{center}
        \centering
        \movie[externalviewer]{\includegraphics[scale=0.5]{images/fluctuations.jpg}}{flyby_large.mpg}
      \end{center}
      \begin{center}
        \centering
...
\frametitle{Work in Progress}
  \begin{columns}
    ...
    \begin{column}{0.6\textwidth}
      \begin{itemize}
        \item \href{https://github.com/AstroVPK/kali}{\textsc{k\={a}l\={i}}} package for light curve analysis
